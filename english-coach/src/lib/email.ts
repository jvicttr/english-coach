...
export function newMessageEmailHtml(senderName: string, messagePreview: string, senderUserId: string): string {
  const escaped = messagePreview.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
  return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="UTF-8" />
        ...
        <table width="100%" style="max-width:560px;background:#111111;border-radius:16px;border:1px solid #1f1f1f;overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px 32px 8px;">
              ...
              <p style="font-size:20px;font-weight:800;color:#ffffff;margin:0 0 8px;text-align:center;">
                Nova mensagem de ${senderName}
              </p>
              <div style="background:#1a1a1a;border:1px solid #2a2a2a;border-radius:12px;padding:16px 20px;margin:20px 0 28px;">
                <p style="font-size:14px;color:#cccccc;margin:0;line-height:1.6;">${escaped}</p>
              </div>
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td align="center">
                    <a href="https://www.faleinglesjv.com/app/mensagens/${senderUserId}"
                       style="display:inline-block;background:#F5C800;color:#000000;font-weight:800;font-size:15px;text-decoration:none;padding:14px 36px;border-radius:50px;">
                      Ver mensagem →
                    </a>
                  </td>
          ...
          <tr>
            <td style="padding:20px 32px;border-top:1px solid #1f1f1f;">
              <p style="font-size:11px;color:#444444;margin:0;text-align:center;">
                Fale Inglês JV · <a href="https://www.faleinglesjv.com" style="color:#666;text-decoration:none;">faleinglesjv.com</a><br/>
                Para não receber notificações por e-mail, responda com "cancelar".
              </p>
            </td>
          </tr>
        </table>

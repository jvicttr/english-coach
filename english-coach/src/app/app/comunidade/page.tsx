            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              {!composerOpen ? (
                ...
                <>
                  ...
                  {showEmojiPicker && (
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(10, 1fr)", gap: 3, background: "#0d0d0d", borderRadius: 8, padding: "8px", marginBottom: 8, maxHeight: "140px", overflowY: "scroll", border: "2px solid #fff", scrollBehavior: "smooth" }}>

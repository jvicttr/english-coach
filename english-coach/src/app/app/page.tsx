...
export default function AppHome() {
  ...
  return (
    <div style={{ background: "var(--black)", minHeight: "100dvh", fontFamily: "'Inter', sans-serif", paddingBottom: 70 }}>
      ...
      <div style={{ padding: "16px", maxWidth: 640, margin: "0 auto", display: "flex", flexDirection: "column", gap: 16, animation: "fadeUp .4s ease" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 10 }}>
            {[
              ...
              },
              {
                ...
                emoji: "🃏",
                title: "Flashcards",
                desc: flashcardPending > 0 ? `${flashcardPending} para revisar` : "Revisar vocabulário",
                iconBg: "rgba(74,222,128,.12)",
                iconColor: "#4ade80",
                badge: flashcardPending > 0 ? { label: `${flashcardPending} pendentes`, color: "#4ade80", bg: "rgba(74,222,128,.12)" } : null,
              },
              {
                href: "/app/progresso",
                emoji: "📊",
              ...
              <a key={card.href} href={card.href} style={{ background: "var(--dark1)", border: "1px solid #1e1e1e", borderRadius: 16, padding: "14px 14px 12px", textDecoration: "none", display: "flex", flexDirection: "column", gap: 8, transition: "border-color .2s" }}

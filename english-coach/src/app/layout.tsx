...
const clerkAppearance = {
  ...
  elements: {
    ...
    badge: { background: "#2a2a2a", color: "#ffffff", border: "1px solid #333" },
    profileSectionTitleText: { color: "#ffffff" },
    profileSectionTitle: { color: "#ffffff", borderColor: "#2a2a2a" },
    profileSectionContent: { color: "#ffffff" },
    profileSectionPrimaryButton: { color: "#F5C800" },
    navbarButton: { color: "#ffffff" },
    navbarButtonIcon: { color: "#ffffff" },
    accordionTriggerButton: { color: "#ffffff" },
    menuItem: { color: "#ffffff" },
    menuItemText: { color: "#ffffff" },
    tableHead: { color: "#aaaaaa" },
    userPreviewMainIdentifier: { color: "#ffffff" },
    userPreviewSecondaryIdentifier: { color: "#aaaaaa" },
    connectedAccountsProviderInitials: { color: "#ffffff" },
